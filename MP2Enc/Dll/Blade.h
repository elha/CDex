...
#ifndef BLADEDLL_H_INCLUDED
#define BLADEDLL_H_INCLUDED

#pragma pack(push,1)


#if (!defined(STATIC_LINK)) && defined (_WIN32)
...
DLLEXPORT BE_ERR	beEncodeChunk(HBE_STREAM hbeStream, DWORD nSamples, PSHORT pSamples, PBYTE pOutput, PDWORD pdwOutput);
